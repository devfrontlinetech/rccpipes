    ...
    <section id="projects" className="projects">
      ...
      <div className="projects-container">
        ...
        <div className="section-title">
          <h2>Our Projects</h2>
          <p>
            We have successfully supplied reinforced concrete pipes and
            precast products for major infrastructure, drainage, and
            construction projects across multiple sectors.
          </p>
        </div>
